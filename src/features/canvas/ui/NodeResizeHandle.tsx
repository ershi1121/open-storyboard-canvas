...
export function NodeResizeHandle({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute bottom-0 right-0 h-3 w-3 border-b border-r border-black/30 transition-colors hover:border-accent dark:border-white/35" />
    </NodeResizeControl>
  );
}